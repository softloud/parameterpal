...
For the normal distribution, this is straightforward, as the parameters reflect the expected value and variance. However, for the beta distribtuion, the parameters are not so readily interpretable. 
...
See `vignette("beta_pal")` for more information, and the mathematical derivations.

# other distributions

No reason the same math can't be applied to other distributions. Open an issue if you'd like me to provide parameters from interpretable conditions for another distributions.
