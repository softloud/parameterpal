...
Escaping the ubiquitous tyranny of the arbitary bounds 90 or 95 per cent, which don't necessarily reflect our intuition, `this_much` is left for the user to define. Suppose we thought only 30 per cent of values fall within the interval. 
...
See `vignette("betapal")` for more information. Fully disclosure, I need to update it after I 
fully understand this [gist](https://gist.github.com/daob/1422e978ff98bdf466fbcb4d9bf3e53e) I was provided with after posting to twitter. Talk about a lesson in open science. Blogpost incoming on open science and why it's good to share bad math and beta research code.
